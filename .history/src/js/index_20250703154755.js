...
closeBtn.addEventListener('click', () => {
  ...
  document.getElementById('toggleBrands').addEventListener('click', function () {
    ...
    if (brandBlock.classList.contains('more__content--shrinked')) {
      ...
      const moreTextBtn = document.querySelector('.more__text');
      ...
      moreButton.addEventListener('click', function () {
          ...
          moreTextBtn.textContent = isExpanded ? 'Скрыть' : 'Показать все';
          moreButton.querySelector('.more__image').classList.toggle('rotated');
      });
